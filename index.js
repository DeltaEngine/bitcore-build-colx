...
function startGulp(name, opts) {
  ...
  var buildPath = './node_modules/bitcore-build-colx/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = browserifyPath + ' --require ./index.js:' + fullname + ' --external bitcore-lib-colx -o ' + fullname + '.js';
    } else {
      browserifyCommand = browserifyPath + ' --require ./index.js:bitcore-lib-colx -o bitcore-lib-colx.js';
    }
